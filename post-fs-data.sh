#!/system/bin/sh
L="/data/adb/Integrity-Basic-Logs/post.log"
MODULE="/data/adb/modules"
MODDIR="$MODULE/integrity_basic"
SRC="$MODULE/integrity_basic/sus.sh"
...
if [ -e /data/adb/modules/integrity_basic/disable ]; then
    rm -rf /data/adb/modules/integrity_basic/disable
...
if [ -e /data/adb/modules/Integrity-Basic]; then
    rm -rf /data/adb/modules/Integrity-Basic
    log "Nuked old integrity basic module"
else
    log "Status 3"
fi
